        ...
        self.app.layout = html.Div( # TOP DIV
            ...
            children=[
                ...
                html.Div( # FILTER CONDITION DIV
                    ...
                    html.Div([
                        ...
                        html.Div([
                            ...
                            html.Button(
                                id="arrow-button",
                                children=html.Img(
                                    src=self.app.get_asset_url("blue_arrow_fig.png"),
                                    style={'height':'80%', 'width':'80%', 'verticalAlign': "middle"}
                                ),
                                style={'padding': '0', 'border': 'none', 'background': 'none', 'verticalAlign': "middle", 'margin-left': '-10px'}
                            ),                            
                    ...
                    ], style={'position': 'relative', 'verticalAlign': "middle", 'height': '700px', 'width': '49%', 'display': 'inline-block', 'border': 'solid'}
