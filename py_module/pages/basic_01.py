...
#                 html.Button('>', n_clicks=0, style=button_style, id='0101-button')
#             ], style=item_style),
#         ],
#         className="page",
#     )
...
layout = html.Div(
            [
                ...
                html.Button('>', n_clicks=0, style=self_style.button_style, id='0101-button')
            ],
            className="page",
        )
...
#                     style=input_style),
#                 html.P('億元', style={'display': 'inline-block'}),
#                 html.Button('x', n_clicks=0, style=button_style, id='0101-x')
#             ], style=item_style)
